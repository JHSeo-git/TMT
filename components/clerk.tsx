...
export function TOCItems({ ref, className, ...props }: ComponentProps<"div">) {
  ...
  if (items.length === 0)
    return <div className="text-fd-muted-foreground p-1 text-xs">No Headings</div>
      ...
      {svg && (
        ...
        >
          <TocThumb
            ...
            className="bg-fd-primary absolute top-(--fd-top) h-(--fd-height) w-full transition-[top,height] duration-250"
          />
        </div>
      )}
